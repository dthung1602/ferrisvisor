...
<div class="grid w-full grid-cols-1 gap-4 md:grid-cols-2 lg:flex lg:flex-row lg:flex-wrap">
  ...
  <div class="relative flex-1 lg:w-48 lg:flex-none lg:shrink-0">
    ...
    >
      <Menu.Trigger
        class="flex w-full items-center justify-between rounded-lg border border-surface-500/30 bg-surface-50 px-3 py-2 backdrop-blur-sm transition-all hover:bg-surface-500/10 active:scale-[0.98] dark:bg-surface-950/40"
      >
  ...
  <div class="relative flex h-10 flex-1 items-center md:col-span-2 lg:min-w-64 lg:flex-1">
    ...
    <input
      ...
      class="input h-10 w-full border-surface-500/30 bg-surface-50 pl-9 backdrop-blur-sm dark:bg-surface-950/40"
    />
  </div>
