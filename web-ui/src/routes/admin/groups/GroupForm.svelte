      ...
      <div class="grid grid-cols-2 gap-4">
        ...
        <div class="col-span-2 space-y-1.5">
          ...
          <div class="flex gap-4">
            <input
              class="input flex-1 rounded-xl border border-surface-200 bg-white px-4 py-3 text-sm shadow-inner focus:ring-2 focus:ring-primary-500/80 dark:border-surface-700 dark:bg-surface-900"
              type="text"
              name="color"
